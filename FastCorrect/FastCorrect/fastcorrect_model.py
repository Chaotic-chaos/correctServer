...
from FastCorrect.FC_utils.fastcorrect_generator import DecoderOut
        ...
        *generator.models* attribute.
        ...
        Args:
            ...
            data_name_or_path (str, optional): point args.data to the archive
                ...
                model archive path.
        """
        import FastCorrect.FC_utils.hub_utils_fc

        x = FastCorrect.FC_utils.hub_utils_fc.from_pretrained(
            model_name_or_path,
            checkpoint_file,
            data_name_or_path,
        ...
        logger.info(x["args"])
        return FastCorrect.FC_utils.hub_utils_fc.GeneratorHubInterface(x["args"], x["task"], x["models"])
